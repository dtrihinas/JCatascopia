...
import eu.celarcloud.jcatascopia.serverpack.beans.AgentObj.AgentStatus;
...
public class AgentRegister implements Runnable{
	...
	private void joinM(JSONObject json){
		String serverIP = null;
		if (this.server.inMaaSMode())
			serverIP = this.server.getAvailableServer();
		else
			serverIP = this.server.getServerIP();
		this.response(Status.OK, serverIP);
	}
