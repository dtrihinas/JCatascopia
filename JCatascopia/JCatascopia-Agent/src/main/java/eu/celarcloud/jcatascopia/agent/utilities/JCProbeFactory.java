...
public class JCProbeFactory {
	...
	private static URL getClassPath() {
		String resName = JCProbeFactory.class.getName().replace('.', '/') + ".class";
		String loc = JCProbeFactory.class.getClassLoader().getResource(resName).toExternalForm();    
		URL cp;
		try {
