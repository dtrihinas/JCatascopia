package eu.celarcloud.jcatascopia.agent.exceptions;

public class CatascopiaException extends Exception {
	private static final long serialVersionUID = 1L;
	
	public enum ExceptionType {ARGUMENT,ATTRIBUTE,KEY,TYPE,QUEUE,PROBE_EXISTANCE,NETWORKING,PACKAGING,FILE_ERROR,SUBCRIPTION,CONNECTION,DATABASE,AGGREGATOR, LOGGING}; 
